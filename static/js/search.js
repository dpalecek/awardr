$(function() {
	...
	window.googleLoadedCallback = function() {
		...
		window.google.load("maps", "3", {
			"callback": window.googleMapsLoadedCallback, other_params: {"sensor": false}
		});
	}
	...
	GOOGLE_API_KEY = "ABQIAAAAbS93tJ_uidHDZWvF7euCFBSJPhMcII7lp6bcofyoVW48E9dl1xTpP3PFKtaxfFOp-v9-N8j7FZ-9Tw";
	
	var script = document.createElement("script");
	script.src = "https://www.google.com/jsapi?key=" + GOOGLE_API_KEY + "&callback=googleLoadedCallback";
